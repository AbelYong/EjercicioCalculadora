...
import com.example.ejerciciocalculadora.Calculator
import com.example.ejerciciocalculadora.ui.theme.EjercicioCalculadoraTheme
        ...
        when (action) {
            ...
            CalculatorAction.Equals -> {
                ...
                try {
                    ...
                    val operationText =
                        "${calculator.formatResult(previous)} ${visibleSymbol(operator)} ${calculator.formatResult(current)} = $result"
            ...
            CalculatorAction.Percent -> {
                val current = uiState.currentNumber.toDoubleOrNull() ?: return
                val result = calculator.percent(current)
